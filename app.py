...
st.title("Nuclear Text Analysis and Research Tool 🔎")
st.markdown("""
...
if model and tokenizer and class_labels:
    ...
    with col2:
        if os.path.exists(IMAGE_PATH):
            ...
            st.warning(
                f"Image not found at {IMAGE_PATH}. Please make sure 'Nuclear_Plant.gif' is in the same directory as the app script.")
